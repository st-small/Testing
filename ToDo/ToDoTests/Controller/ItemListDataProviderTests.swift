...
final class ItemListDataProviderTests: XCTestCase {
    ...
    func test_CellForRow_DequeuesCellFromTableView() {
        ...
        XCTAssertTrue(mockTableView.cellGotQueued)
    }
    ...
    func test_CellForRow_CallsConfigCell() {
        ...
        XCTAssertEqual(item, cell.catchedItem)
    }
    ...
    func test_SelectingACell_SendsNotification() {
        ...
        expectation(forNotification: NSNotification.Name("ItemSelectedNotification"), object: nil) { notification -> Bool in
